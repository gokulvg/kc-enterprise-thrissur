  ...
  return (
    <Box className='flex  items-center flex-col gap-6 mt-10'>
      ...
      <Box className='grid grid-cols-2 gap-6 items-center' >
        ...
        <Heading size='sm'>K.C Enterprises in Thamburan Lane, Thamburan Lane& P.O Road has a wide range of products and / or services to cater to the varied requirements of their customers. The staff at this establishment are courteous and prompt at providing any assistance. They readily answer any queries or questions that you may have. This establishment is functional from 9:30 - 19:00. </Heading>
        <Heading size='md' className='mt-6'>Location and Overview:</Heading>
        <Heading size='sm'>
        K.C Enterprises in Thamburan Lane, Thamburan Lane& P.O Road, Thrissur is a top player in the category Carpet Dealers in the Thrissur.
